...
<head>
    ...
    <!-- Custom CSS -->
	<link rel="stylesheet" href="pages/css/reset.css"> <!-- CSS reset -->
    <link rel="stylesheet" href="pages/css/style.css">
	<link rel="stylesheet" href="pages/css/animated-logo.min.css"><!-- Logo -->
	<link rel="stylesheet" href="pages/css/our-team.css"> <!-- Resource style -->
	
	<!-- Custom Fonts -->
    <link href="pages/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
	
	<!-- Js -->
	<script src="pages/js/modernizr.js"></script> <!-- Modernizr -->
...
<body>
	...
	<embed src="pages/musics/成都.mp3"  autostart="true" loop="false" hidden="false"></embed>
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">江东弟子多才俊丶</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="#services">NotCoding</a>
                    </li>
					<li>
                        <a class="page-scroll" href="#new">faep</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="#about">About</a>
                    </li>
					<li>
                        <a class="page-scroll" href="#team">BOLGS</a>
                    </li>
                    <li>
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="intro-text">
						<div class="intro-lead-in">Welcome To My HomePage!</div>
						<div class="intro-heading">最怕一生碌碌无为 还说平凡难能可贵</div>
					</div>
					<a class="btn btn-1 btn-sm" href="#about">Faep</a>
					<a class="btn btn-1 btn-sm" href="#team">NOTE</a>
				</div>
			</div>
		</div>
    </header>
	<!-- Header -->
	<div class="copyrights">Collect from <a href="http://www.cssmoban.com/" >某网站链接</a></div>
	<!-- /////////////////////////////////////////Content -->
	<div id="page-content" class="index-page">
			...
			<div class="container">
				<div class="row heading">
					<div class="col-lg-12">
						<h2>XXXXXXXXXX</h2>
						<hr>
						<div class="intro">Life is not just writing code ！</div>
					</div>
				</div>
				<div class="row">
					<div class="col-sm-3 box-item">
						<div class="wrap-img">
							<img src="images/guomi.gif" width="107" height="107"/>
						</div>
						<h3 class="blue">国际米兰FC</h3>
						<p>Forza milan</p>
						<button type="submit" class="btn btn-2 ">More</button>
					</div>
					<div class="col-sm-3 box-item">
						<div class="wrap-img">
							<img src="/images/suning.png" width="80" height="80"/>
						</div>
						<h3 class="yellow">江苏苏宁FC</h3>
						<p>一日为蓝、终生为蓝</p>
						<button class="btn btn-2 ">More</button>
					</div>
					<div class="col-sm-3 box-item">
						<div class="wrap-img">
							<img src="WEB-INF/pages/images/知乎.png"  width="105" height="105"/>
						</div>
						<h3 class="red">知乎</h3>
						<p>与世界分享你的知识、经验和见解</p>
						<button id="zhbtn" class="btn btn-2 ">More</button>
					</div>
					<div class="col-sm-3 box-item">
						<div class="wrap-img">
							<img src="/WEB-INF/pages/images/Setting.png" />
						</div>
		...
		<section id="new" class="box-content box-2 box-style">
			<div class="container">
				<div class="row">
					<blockquote>让我掉下眼泪的 不止昨夜的酒 <br/>直到所有的灯都熄灭了也不停留 </blockquote>
				</div>		
			</div>
		</section>
						...
						<ul class="timeline">
							<li class="blue">
								<div class="timeline-image">
									<img class="img-circle img-responsive" src="pages/images/4.jpg" alt="">
								</div>
							...
							<li class="timeline-inverted red">
								<div class="timeline-image">
									<img class="img-circle img-responsive" src="pages/images/5.jpg" alt="">
								</div>
								<div class="timeline-panel">
									<div class="timeline-heading">
										<h4>March 2011</h4>
							...
							<li class="green">
								<div class="timeline-image">
									<img class="img-circle img-responsive" src="pages/images/6.jpg" alt="">
								</div>
								<div class="timeline-panel">
									<div class="timeline-heading">
										<h4>December 2012</h4>
							...
							<li class="timeline-inverted yellow">
								<div class="timeline-image">
									<img class="img-circle img-responsive" src="pages/images/7.jpg" alt="">
								</div>
								<div class="timeline-panel">
									<div class="timeline-heading">
										<h4>July 2014</h4>
				...
				<div class="cd-testimonials-wrapper cd-container">
					<ul class="cd-testimonials">
						<li>
							...
							<div class="cd-author">
								<img src="pages/images/avatar-1.jpg" alt="Author image">
						...
						<li>
							...
							<div class="cd-author">
								<img src="pages/images/avatar-2.jpg" alt="Author image">
								<ul class="cd-author-info">
									<li>MyName</li>
						...
						<li>
							...
							<div class="cd-author">
								<img src="pages/images/avatar-3.jpg" alt="Author image">
								<ul class="cd-author-info">
									<li>MyName</li>
					...
					<div class="cd-testimonials-all-wrapper">
						<ul>
							...
							<li class="cd-testimonials-item">
								...
								<div class="cd-author">
									<img src="pages/images/avatar-4.jpg" alt="Author image">
									<ul class="cd-author-info">
										<li>MyName</li>
										<li>CEO, CompanyName</li>
									</ul>
							...
							<li class="cd-testimonials-item">
								...
								<div class="cd-author">
									<img src="pages/images/avatar-5.jpg" alt="Author image">
									<ul class="cd-author-info">
										<li>MyName</li>
										<li>CEO, CompanyName</li>
									</ul>
							...
							<li class="cd-testimonials-item">
								...
								<div class="cd-author">
									<img src="pages/images/avatar-6.jpg" alt="Author image">
									<ul class="cd-author-info">
										<li>MyName</li>
										<li>CEO, CompanyName</li>
									</ul>
	...
	<footer>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-4 col-footer footer-3">
						<div class="row">
							<div class="col-md-6">
								<a href="#"><img src="pages/images/15.jpg" /></a>
							</div>
							<div class="col-md-6">
								<a href="#"><img src="pages/images/16.jpg" /></a>
							</div>
						</div>
						<div class="row">
							<div class="col-md-6">
								<a href="#"><img src="pages/images/17.jpg" /></a>
							</div>
							<div class="col-md-6">
								<a href="#"><img src="pages/images/18.jpg" /></a>
							</div>
						</div>
						<div class="row">
							<div class="col-md-6">
								<a href="#"><img src="pages/images/19.jpg" /></a>
							</div>
							<div class="col-md-6">
								<a href="#"><img src="pages/images/20.jpg" /></a>
							</div>
						</div>
						<div class="row">
							<div class="col-md-6">
								<a href="#"><img src="pages/images/21.jpg" /></a>
							</div>
							<div class="col-md-6">
								<a href="#"><img src="pages/images/18.jpg" /></a>
							</div>
		...
		<div class="copyright">
			<div class="container">
				<div class="row">
					<div class="col-md-4">
						<p>Copyright &copy; 2017.Faep All rights reserved.</p>
					</div>
					<div class="col-md-4">
	...
	<script src="pages/js/main.js"></script> <!-- Resource jQuery -->

	<!-- Bootstrap Core JavaScript -->
	<script src="pages/js/bootstrap.min.js"></script>

	<!-- Custom Theme JavaScript -->
	<script src="pages/js/agency.js"></script>

	<!-- Animated Top -->
	<script src="pages/js/jquery.easing.min.js"></script>
	<script src="pages/js/classie.js"></script>
	<script src="pages/js/cbpAnimatedHeader.js"></script>
